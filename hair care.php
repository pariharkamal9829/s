      ...
      <a class="navbar-brand" href="login system php/index.php">Parmar Impex</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="login system php/index.php">Home</a>
                </li>
     <li class="nav-item">
...
<h2 class="tittle"> Hair Care products</h2>
  ...
  <div id="carouselExampleDark" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="1000">
        <img src="image/hair 1.jpg" class="d-block w-100 rounded-5" >
      ...
      <div class="carousel-item" data-bs-interval="2000">
        <img src="image/hair 2.jpg" class="d-block w-100 rounded-5" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="image/hair 3.jpg" class="d-block w-100 rounded-5" alt="...">
        <div class="carousel-caption d-none d-md-block">
